    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-gradient-to-b from-background to-black/50">
      <div className="container">
        ...
        <div
          ref={ref}
          className={cn(
            "max-w-2xl mx-auto bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-xl",
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" disabled={submitted} className="w-full bg-primary hover:bg-primary/90 text-white">
