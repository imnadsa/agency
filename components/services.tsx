...
function ServiceCard({ icon, title, description, index, logos, features, onClick }: ServiceCardProps) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "bg-secondary border border-white/10 rounded-2xl p-6 transition-shadow transition-opacity transition-transform duration-300 relative overflow-hidden group min-h-[400px]", // Добавляем минимальную высоту
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            <div
              className={cn(
                "mt-auto inline-flex items-center text-sm font-medium text-accent-cyan opacity-0 transform translate-x-[-10px] transition-all duration-250",
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          {/* Остальные карточки в сетке 2x2 */}
