...
const SmmIcon = () => (
  ...
  >
    <path
      d="M241 3.2c-3.4 2-5.4 3.1-20 11-3.6 2-13.9 7.6-23 12.5s-19.9 10.8-24 13c-9.9 5.3-38.9 21.1-52 28.3-5.8 3.2-22 12-36 19.5-14 7.6-30.7 16.6-37 20-6.3 3.4-19.1 10.4-28.5 15.5C2.1 132.9-.4 134.7.6 137.3c.3.9 5.6 4.4 11.7 7.8 6.2 3.4 13.7 7.7 16.7 9.5 3 1.7 7.2 4.1 9.3 5.3 15.3 8.6 14.5 7.7 9.7 11.2-2.2 1.6-4 3.3-4 3.7 0 1.9 3 4.3 10.5 8.5 4.4 2.5 17 9.7 28 16l20 11.4.3 22.8c.2 23.1.6 25.5 4.1 25.5.8 0 8.6-7.3 17.3-16.3l15.7-16.2V253c.1 22.1.4 26.9 1.6 28.7 1 1.4 2.2 2 3.2 1.6 1.4-.6 24.4-23.7 35.8-36 5.5-6.1 7-6.4 15.3-2.9 24.1 10.1 58.5 23.6 60.1 23.6 1 0 2.3-.6 2.8-1.3.6-.6 1.8-11.6 2.7-24.2 2.1-28.7 5-68.3 7.1-96.5 2.9-41.3 4.5-62.6 5.5-73.6 1.5-16.6 1.3-20.1-.9-21.3-2-1.1-3-.7-18.3 7.7-4.2 2.3-7.8 3.9-8.1 3.5-.2-.5.5-14 1.6-30.1 1.8-25.5 1.9-29.5.6-30.3-2.1-1.3-4-1-7.9 1.3zm-13.9 36.4c1.4 1.7 1.2 5.7-8.1 129.4-1.1 14.6-2.2 30.2-2.6 34.8-.8 11.6-1.3 11.8-17.1 5.3-6.8-2.8-19.5-8-28.3-11.6l-16.1-6.5-14.8 15.2c-14.4 14.8-14.9 15.2-17.5 14L120 219v-34.5l11.3-17.8c6.1-9.7 16.5-26.1 23-36.3 6.5-10.2 11.7-18.8 11.5-18.9-.3-.3-8.7 5-62.8 40.4-9.6 6.3-18.5 11.6-19.7 11.9-2.5.5-39.9-20.3-41.4-23-1.1-2.1-.4-4 2-5.5 1-.6 29-15.9 62.2-33.8 33.2-18 61.8-33.5 63.4-34.5 1.7-.9 7.5-4.1 13-7 5.5-2.9 10.5-5.6 11-6 .6-.4 5.3-3 10.6-5.8s11.6-6.3 14-7.7c5.1-2.9 7.2-3.1 9-.9zM689 160.5V205h18v-89h-18v44.5zM345.5 118c-16.3 3.3-25.3 15.7-22.5 30.8 1.9 10.2 7.9 15.5 23 20.2 11.5 3.6 15 6.2 15 11.5 0 4.9-1.5 7.4-5.5 9.1-5.4 2.2-9.7 1.7-17.1-2.1-9.6-4.8-11.7-4.7-15.4 1.2-1.6 2.7-3 5.5-3 6.3 0 2.2 5.7 5.7 13.7 8.5 9 3.2 20.8 3.4 28.7.5 16.6-6.3 23.1-28.9 11.9-41.5-2.9-3.3-8.3-6.1-17.3-9.1-8-2.6-13.6-5.5-15.2-7.9-1.9-2.6-.8-7.3 2.3-9.9 4.4-3.7 10.7-3.5 19.3.5 3.6 1.7 7 2.7 7.7 2.4 1.7-1.1 6.9-9.7 6.9-11.4 0-2.4-9-7-16.7-8.6-7.5-1.6-9.8-1.7-15.8-.5zM393 118.8c-.7.3-1 14.3-1 43.3V205h18v-28.3c0-32.9-1.6-32.6 13.5-3 5.4 10.6 10.6 20 11.6 20.9 2.2 2 10.2 2.2 12.3.5.8-.7 3.5-5.3 6.1-10.4 11.1-21.6 17.8-34.3 18.6-35.2.5-.5.9 11.2.9 27.3V205h17v-42.9c0-35.3-.2-43-1.4-43.4-1.4-.6-16.2.1-18.3.8-.6.2-7.3 12.7-14.8 27.7-7.6 15-13.8 27.4-14 27.6-.1.1-6.4-12-14-27s-14.1-27.6-14.4-28.1c-.7-.7-18.1-1.5-20.1-.9zM515.3 118.7l-7.3.4v42.8c0 23.5.2 43 .4 43.2.2.2 4.1.3 8.5.1l8.1-.4v-28.1c0-16.3.4-27.7.9-27.2.5.6 5.9 10.7 12.1 22.5 6.1 11.8 11.8 22.1 12.5 22.9 1.9 2 10.2 1.7 12.5-.4 1-.9 6.4-10.7 12.1-21.8 5.6-11.1 10.8-21.1 11.6-22.2 1.1-1.6 1.3 2.3 1.3 26.3v28.3l8.8-.3 8.7-.3.2-41.9c0-23.1-.1-42.4-.3-43-.5-1.2-15.4-1.4-18.9-.3-1.4.5-6.2 9.1-15.9 28.4l-13.8 27.7-13.5-26.9c-7.4-14.9-14-27.5-14.6-28.2-1.6-1.6-4.9-2-13.4-1.6zM649.3 143.9c-2.8.9-6.7 2.9-8.6 4.4l-3"
    />
  </svg>
);
...
const YandexIcon = () => (
  <svg
    ...
    className="w-12 h-12 transition-transform duration-200 hover:scale-110 hover:rotate-3"
  >
    <mask id="a" width="50" height="50" x="0" y="0" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }}>
    ...
    <defs>
      <linearGradient id="b" x1="136.285" x2="-23.804" y1="66.72" y2="85.549" gradientUnits="userSpaceOnUse">
...
const N8nIcon = () => (
  ...
  >
    ...
    <path
      fill="#101330"
      fillRule="evenodd"
      d="M407.017 86.887v-.571c4.187-2.097 8.374-5.719 8.374-12.867 0-10.294-8.469-16.489-20.173-16.489-11.99 0-20.554 6.576-20.554 16.679 0 6.863 3.996 10.58 8.374 12.677v.571c-4.853 1.716-10.658 6.863-10.658 15.441 0 10.388 8.564 17.632 22.743 17.632 14.178 0 22.457-7.244 22.457-17.632 0-8.578-5.71-13.63-10.563-15.441zm-11.894-21.158c4.758 0 8.278 3.049 8.278 8.196s-3.616 8.197-8.278 8.197c-4.663 0-8.565-3.05-8.565-8.197 0-5.242 3.712-8.196 8.565-8.196zm0 45.081c-5.52 0-9.992-3.526-9.992-9.531 0-5.432 3.711-9.531 9.896-9.531 6.091 0 9.802 4.003 9.802 9.722 0 5.814-4.282 9.34-9.706 9.34z"
      clipRule="evenodd"
    />
    <path
      fill="#101330"
      d="M432.26 119.007h12.18V93.178c0-8.483 5.139-12.2 10.943-12.2 5.71 0 10.182 3.813 10.182 11.628v26.401h12.18V90.128c0-12.486-7.232-19.729-18.555-19.729-7.137 0-11.134 2.859-13.989 6.576h-.761l-1.047-5.623H432.26v47.655zM324.44 119.007h-12.18V71.352h11.133l1.047 5.623h.761c2.855-3.717 6.852-6.576 13.989-6.576 11.323 0 18.555 7.243 18.555 19.729v28.879h-12.18V92.606c0-7.815-4.472-11.628-10.182-11.628-5.804 0-10.943 3.717-10.943 12.2v25.829z"
    />
  </svg>
);
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2
            ...
            className={cn(
              ...
              inView ? "opacity-100 translate-y-0" : "opacity-0 translategeç-y-10",
            )}
